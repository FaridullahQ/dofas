...
class McitSpendRequest(models.Model):
    ...
    commitment_id = fields.Many2one(
        "mcit.commitment", string="Primary Reserve", readonly=True, copy=False,
    ...
    commitment_ids = fields.One2many(
        "mcit.commitment", "spend_request_id", string="Budget Reserves", copy=False,
    ...
    advance_id = fields.Many2one(
        "mcit.advance", string="Employee Advance", readonly=True, copy=False,
    ...
    def action_disburse_advance(self):
        ...
        (mcit.advance, advance_type='employee'), linked back to this
        ...
        advance = self.env["mcit.advance"].create({
    ...
    def _action_create_split_expenses(self, commitments):
        ...
        mcit.expense (one budget_line_id, one commitment_id) can't represent
        ...
        commitment, see mcit_expense.py), posting, and the actuals/available
        figures on mcit.budget.line - exactly mirroring the split made at
        ...
        return {
            "type": "ir.actions.act_window", "res_model": "mcit.expense",
    ...
    def action_view_commitments(self):
        self.ensure_one()
        action = self.env["ir.actions.act_window"]._for_xml_id("mcit_budget.action_mcit_commitment")
    ...
    def action_open_split_wizard(self):
        ...
        return {
            ...
            "res_model": "mcit.spend.request.split.wizard",
            "view_mode": "form",
            "target": "new",
            "context": {"default_request_id": self.id},
        }
