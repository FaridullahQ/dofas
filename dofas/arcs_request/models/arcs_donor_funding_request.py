...
class ArcsDonorFundingRequest(models.Model):
    ...
    is covering. Kept in arcs_request so arcs.donor.funding.request stays a
    reusable primitive in arcs_fund with no knowledge of the acquisition
    ...
    increase (edit the line or raise an arcs.budget.transfer), keeping
    financial control changes explicit and reviewable."""

    _inherit = "arcs.donor.funding.request"
