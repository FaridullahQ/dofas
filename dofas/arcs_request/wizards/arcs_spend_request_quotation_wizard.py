...
class ArcsSpendRequestQuotationWizard(models.TransientModel):
    ...
    _name = "arcs.spend.request.quotation.wizard"
    ...
    line_ids = fields.One2many(
        "arcs.spend.request.quotation.line", "wizard_id", string="Quoted Items")
    ...
    def action_confirm(self):
        ...
        self.attachment_ids.write({
            "res_model": "arcs.spend.request", "res_id": self.request_id.id,
        })
...
class ArcsSpendRequestQuotationLine(models.TransientModel):
    _name = "arcs.spend.request.quotation.line"
    _description = "Quoted Item"

    wizard_id = fields.Many2one(
        "arcs.spend.request.quotation.wizard", required=True, ondelete="cascade")
    request_line_id = fields.Many2one(
        "arcs.spend.request.line", string="Item", required=True, readonly=True)
