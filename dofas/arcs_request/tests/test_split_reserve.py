...
class TestArcsSpendRequestSplitReserve(TransactionCase):
    ...
    def setUpClass(cls):
        ...
        cls.exp_acc = cls.env["account.account"].create(
            {"name": "Programme", "code": "ARCSREQ600", "account_type": "expense"})
    ...
    def test_create_expense_splits_one_per_line(self):
        ...
        expenses = self.env["arcs.expense"].search(action["domain"])
