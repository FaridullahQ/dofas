...
class ArcsReasonWizard(models.TransientModel):
    ...
    arcs.reason.action.mixin's action_*_wizard methods rather than the raw
    ...
    arcs.approval.mixin._transition, which also posts it to the chatter)."""

    _name = "arcs.reason.wizard"
