...
class ArcsCommitment(models.Model):
    _name = "arcs.commitment"
    _description = "Budget Commitment (Encumbrance)"
    _order = "create_date desc, id desc"

    budget_line_id = fields.Many2one("arcs.budget.line", required=True, ondelete="restrict", index=True)
    ...
    def _selection_source(self):
        candidates = ["arcs.expense", "arcs.procurement"]
