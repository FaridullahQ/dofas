...
class ArcsBudget(models.Model):
    ...
    line_ids = fields.One2many("arcs.budget.line", "budget_id", string="Budget Lines")
    ...
    def action_create_revision(self):
        ...
        return {"type": "ir.actions.act_window", "res_model": "arcs.budget",
