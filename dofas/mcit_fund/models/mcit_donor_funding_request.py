...
class McitDonorFundingRequest(models.Model):
    ...
    - Send Email (action_open_send_wizard): composes and actually delivers
      ...
      by itself send anything - mirroring mcit.fund.receipt's
    ...
    - Recording the donor's approval requires proof: a bank receipt
      ...
      differ from what was requested), mirroring mcit.fund.receipt's
    ...
    def action_open_send_wizard(self):
        ...
        return {
            ...
            "res_model": "mcit.donor.funding.request.send.wizard",
            "view_mode": "form",
            "target": "new",
