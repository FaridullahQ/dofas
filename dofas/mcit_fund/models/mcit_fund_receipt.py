...
class McitFundReceipt(models.Model):
    ...
    def create(self, vals_list):
        for vals in vals_list:
            if vals.get("name", _("New")) == _("New"):
                vals["name"] = self.env["ir.sequence"].next_by_code("mcit.fund.receipt") or _("New")
    ...
    def action_print_thanks(self):
        self.ensure_one()
        return self.env.ref("mcit_fund.action_report_fund_thanks").report_action(self)
    ...
    def _get_or_create_thanks_attachment(self):
        ...
        if existing:
            return existing
        report = self.env.ref("mcit_fund.action_report_fund_thanks")
    ...
    def action_open_send_wizard(self):
        ...
        return {
            ...
            "res_model": "mcit.fund.receipt.send.wizard",
            "view_mode": "form",
            "target": "new",
